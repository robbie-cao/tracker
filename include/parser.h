...
typedef struct {
	...
	kal_uint32				tknLen ;	/**< length of token string */
}	ParserToken_t ;
...
Result_t ParserTknToStr ( 
	...
	kal_uint32				maxChr			/**<	max number of chars in string buffer */
) ;
...
Result_t ParserStrToInt ( 
	...
	kal_int32*				retVal			/**<	the integer, returned */
) ;

/** Convert a token to a kal_uint8.  \return RESULT_ERROR if not a valid kal_uint8; else RESULT_OK 
 */
Result_t ParserStrToUInt8( 
	const char*				str,			/**<	the string */
	kal_uint8*				retVal			/**<	the kal_uint8, returned */
) ;
...
Result_t ParserTknToUInt ( 
	ParserToken_t*			tkn, 
	kal_uint32*				retVal			/**<	the integer, returned */
) ;
...
Result_t ParserCatTkns( 
	...
	kal_uint8				n_tkn,			/**<	number of tokens in array */
	kal_uint8*				strOut,			/**<	output string buffer */
	kal_uint16				maxChr			/**<	max chars to copy including NULL */
) ;
